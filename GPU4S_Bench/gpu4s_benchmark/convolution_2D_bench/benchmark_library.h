...
struct GraficObject{
	...
	// CUDA PART
	bench_t* d_A;
	bench_t* d_A_redundant_1;
	bench_t* d_A_redundant_2;
	bench_t* d_B;
	bench_t* d_B_redundant_1;
	bench_t* d_B_redundant_2;
	bench_t* kernel;
	bench_t* kernel_redundant_1;
	bench_t* kernel_redundant_2;
	...
	bench_t* d_A;
	bench_t* d_result;
	bench_t* d_result_redundant_1;
	bench_t* d_result_redundant_2;
	bench_t* kernel;
	#endif
	float elapsed_time;
};
