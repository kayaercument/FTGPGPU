...
void execute_kernel(GraficObject *device_object, unsigned int n, unsigned int m,unsigned int w){
    ...
    lrn_kernel<<<dimGrid, dimBlock>>>(device_object->d_A, device_object->d_B_redundant_1, n);
    lrn_kernel<<<dimGrid, dimBlock>>>(device_object->d_A, device_object->d_B_redundant_2, n);
...
void clean(GraficObject *device_object){
    ...
    err = cudaFree(device_object->d_A_redundant_1);
    ...
    err = cudaFree(device_object->d_A_redundant_2);
