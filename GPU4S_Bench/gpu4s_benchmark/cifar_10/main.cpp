...
int main(int argc, char *argv[]){
	...
	cifar10_bench->HOST_dense_layer_1_output = (bench_t*) malloc ( DENSE_1 * sizeof(bench_t));
	cifar10_bench->HOST_dense_layer_1_output_redundant_1 = (bench_t*) malloc ( DENSE_1 * sizeof(bench_t));
	cifar10_bench->HOST_dense_layer_1_output_redundant_2 = (bench_t*) malloc ( DENSE_1 * sizeof(bench_t));

	cifar10_bench->HOST_dense_layer_2_output = (bench_t*) malloc ( DENSE_2 * sizeof(bench_t));
	cifar10_bench->HOST_dense_layer_2_output_redundant_1 = (bench_t*) malloc ( DENSE_2 * sizeof(bench_t));
	cifar10_bench->HOST_dense_layer_2_output_redundant_2 = (bench_t*) malloc ( DENSE_2 * sizeof(bench_t));

	cifar10_bench->HOST_conv_1_output = (bench_t*) malloc ( size_A * size_A * sizeof(bench_t));
	cifar10_bench->HOST_conv_1_output_redundant_1 = (bench_t*) malloc ( size_A * size_A * sizeof(bench_t));
	cifar10_bench->HOST_conv_1_output_redundant_2 = (bench_t*) malloc ( size_A * size_A * sizeof(bench_t));

	cifar10_bench->HOST_conv_2_output = (bench_t*) malloc ( size_pooling_1 * size_pooling_1 * sizeof(bench_t));
	cifar10_bench->HOST_conv_2_output_redundant_1 = (bench_t*) malloc ( size_pooling_1 * size_pooling_1 * sizeof(bench_t));
	cifar10_bench->HOST_conv_2_output_redundant_2 = (bench_t*) malloc ( size_pooling_1 * size_pooling_1 * sizeof(bench_t));
