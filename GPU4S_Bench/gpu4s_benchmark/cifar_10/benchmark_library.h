...
struct GraficObject{
	...
	bench_t* conv_1_output_redundant_1;
	bench_t* conv_1_output_redundant_2;
	bench_t* HOST_conv_1_output;
	bench_t* HOST_conv_1_output_redundant_1;
	bench_t* HOST_conv_1_output_redundant_2;
	bench_t* pooling_1_output;
	bench_t* kernel_2;
	bench_t* conv_2_output;
	bench_t* conv_2_output_redundant_1;
	bench_t* conv_2_output_redundant_2;
	bench_t* HOST_conv_2_output;
	bench_t* HOST_conv_2_output_redundant_1;
	bench_t* HOST_conv_2_output_redundant_2;
	bench_t* pooling_2_output;
	bench_t* dense_layer_1_weights;
	bench_t* dense_layer_1_output;
	bench_t* dense_layer_1_output_redundant_1;
	bench_t* dense_layer_1_output_redundant_2;
	bench_t* HOST_dense_layer_1_output;
	bench_t* HOST_dense_layer_1_output_redundant_1;
	bench_t* HOST_dense_layer_1_output_redundant_2;
	bench_t* dense_layer_2_weights;
	bench_t* dense_layer_2_output;
	bench_t* dense_layer_2_output_redundant_1;
	bench_t* dense_layer_2_output_redundant_2;
	bench_t* HOST_dense_layer_2_output;
	bench_t* HOST_dense_layer_2_output_redundant_1;
	bench_t* HOST_dense_layer_2_output_redundant_2;
	bench_t* output_data;
	bench_t* sum_ouput;
